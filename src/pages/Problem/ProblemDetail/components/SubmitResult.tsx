...
const Result: React.FC<any> = () => {
    ...
    return (
        <div style={labelStyle}>
            {problemSubmitContent?.status === 2 ? (
                <Col style={{margin: '20px 0'}}>
                    <Row style={{margin: '20px', width: '100%'}}>
                        <Alert
                            style={{width: '60%'}}
                            message={problemSubmitContent?.judgeInfo.message}
                            type="success"
                            showIcon
                        />
                    </Row>
                    <Row style={{margin: '20px', width: '100%'}}>
                        <Card style={{width: '40%', marginRight: 10}}>
                            <Space size='small' style={{marginBottom: 10}}>
                                时间 {problemSubmitContent?.judgeInfo?.judgeConfig?.timeLimit} ms
                            </Space>
                        </Card>
                        <Card style={{width: '40%', marginLeft: 10}}>
                            <Space size='small' style={{marginBottom: 10}}>
                                内存消耗 {problemSubmitContent?.judgeInfo?.judgeConfig?.memoryLimit} KB
                            </Space>
                        </Card>
                    </Row>
                </Col>
